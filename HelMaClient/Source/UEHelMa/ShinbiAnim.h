...
#include "ShinbiAnim.generated.h"
...
UCLASS()
class UEHELMA_API UShinbiAnim : public UAnimInstance
{
	GENERATED_BODY()
...
protected:
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Meta = (AllowPrivateAccess = "true", Bitmask, BitmaskEnum = "EShinbiAnim"))
	uint8 AnimType;
